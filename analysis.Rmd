...
feature_table_file <- as.character(glue("./data/feature_table.json"))
metadata_file <- as.character(glue("./data/metadata_table.tsv"))
taxmat_file <- as.character(glue("./data/taxonomy_table.tsv"))
contamination_file <- as.character("./data/contaminants.tsv")
